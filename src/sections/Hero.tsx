      ...
      <div className="container">
        <div className='md:flex items-center'>
          ...
          <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
            ...
            <motion.img src={noodleImage.src} width={220} alt='noodel image' className='absolute top-[524px] left-[448px] hidden lg:block rotate-[30deg]' style={{ rotate: 30, translateY: translateY,}} />
          </div>
        </div>
      </div>
    </section>
